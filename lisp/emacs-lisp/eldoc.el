...
(defcustom eldoc-documentation-strategy #'eldoc-documentation-default
  "How to collect and organize the results of `eldoc-documentation-functions'.

The special hook `eldoc-documentation-functions' specifies the
multiple sources of documentation available, while this variable
controls how it is queried and how its results are organized
before being displayed to the user.  The following values are
allowed:
